...
class AvailableAlgorithms(str, Enum):
    BEST_CHOICE_HILL_CLIMBING = (
        "BestChoiceHillClimbing"  # BestChoiceHillClimbing.__name__
    )
    FIRST_CHOICE_HILL_CLIMBING = (
        "FirstChoiceHillClimbing"  # FirstChoiceHillClimbing.__name__
    )
    RANDOM_CHOICE_HILL_CLIMBING = (
        "RandomChoiceHillClimbing"  # RandomChoiceHillClimbing.__name__
    )
    # SIMULATED_ANNEALING = "SimulatedAnnealing"  # SimulatedAnnealing.__name__
    # TABU_SEARCH = "TabuSearch"  # TabuSearch.__name__
    # GENETIC_ALGORITHM = "GeneticAlgorithm"  # GeneticAlgorithm.__name__
